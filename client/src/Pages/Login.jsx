...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!loginDetails.email.trim() || !loginDetails.password ) {
  ...
  return (
    <div className="flex min-h-screen max-h-[100vh] overflow-hidden w-screen  items-center justify-center text-gray-600 bg-gray-50">
        ...
        <div className="relative flex flex-col sm:w-[30rem] rounded-lg border-gray-400 bg-white shadow-lg px-4">
          <div className="flex-auto p-6">
            ...
            <form onSubmit={handleSubmit} id="" className="mb-4" >
              ...
              <div className=" text-[13px] text-red-500 px-2">
                {error ? error : ""}
              </div>
              <div className="mb-4">
